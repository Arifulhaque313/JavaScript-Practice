...
<body>
    ...
    <div id="wrapper">
        <form method="POST" action="index.php" onsubmit="return Validate()" name="vform">
            ...
            <div id="select_div">
                <label>Username</label> <br>
                <select name="select" id="" class="textInput">
    ...
    <script>
        ...
        var select = document.forms['vform']['select'];
        ...
        select.addEventListener('blur', selectVerify, true);
        ...
        function Validate() {
            ...
            if (select.value == "") {
                ...
                document.getElementById('select_div').style.color = "red";
                select_error.textContent = "Username is required";
                select.focus();
                return false;
            }
        ...
        function selectVerify() {
            if (select.value != "") {
                select.style.border = "1px solid #5e6e66";
                document.getElementById('select_div').style.color = "#5e6e66";
